...
import { MailType, UpdateMailLabelType, FetchMailParamsType, UpdateMailParamsType, PaginateMailParamsType } from 'src/types/apps/emailTypes';
...
// ** Update Mail
export const updateMail = createAsyncThunk('appEmail/updateMail', async (params: UpdateMailParamsType, { dispatch, getState }: ReduxType) => {
