  ...
  return (
    <Grid container spacing={6} className='match-height'>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>TreeView</code> & <code>TreeItem</code> components and <code>defaultCollapseIcon</code> & <code>defaultExpandIcon</code> props
            with <code>TreeView</code> component for a simple tree view.
          </Typography>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Manage <code>expanded</code>, <code>selected</code>, <code>onNodeToggle</code> and <code>onNodeSelect</code> props with the help of
            states.
          </Typography>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <TreeViewGmailClone direction={initialSettings.direction} />
        </CardSnippet>
      </Grid>
    </Grid>
  );
