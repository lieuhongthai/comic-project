    ...
    <Box sx={{ display: 'flex', flexWrap: 'wrap' }} className='demo-space-x'>
      <div>
        <DatePicker
          ...
          customInput={<CustomInput label='Date Range' start={startDate as Date | number} end={endDate as Date | number} />}
        />
      </div>
      <div>
        <DatePicker
          ...
          popperPlacement={popperPlacement}
          customInput={<CustomInput label='Multiple Months' end={endDateRange as Date | number} start={startDateRange as Date | number} />}
        />
      </div>
    </Box>
  );
