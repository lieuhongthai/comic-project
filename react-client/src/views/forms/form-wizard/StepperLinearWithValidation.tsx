        ...
        return (
          <form key={0} onSubmit={handleAccountSubmit(onSubmit)}>
            <Grid container spacing={5}>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  <InputLabel htmlFor='stepper-linear-account-confirm-password' error={Boolean(accountErrors['confirm-password'])}>
                    Confirm Password
                  </InputLabel>
                  <Controller
        ...
        return (
          <form key={1} onSubmit={handlePersonalSubmit(onSubmit)}>
            <Grid container spacing={5}>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  <InputLabel id='stepper-linear-personal-country' error={Boolean(personalErrors.country)} htmlFor='stepper-linear-personal-country'>
                    Country
                  </InputLabel>
                  <Controller
                    name='country'
          ...
          <Stepper activeStep={activeStep}>
            {steps.map((step, index) => {
              ...
              if (index === activeStep) {
                ...
                if (
                  (accountErrors.email || accountErrors.username || accountErrors.password || accountErrors['confirm-password']) &&
                  activeStep === 0
                ) {
                  labelProps.error = true;
                } else if (
                  (personalErrors.country || personalErrors.language || personalErrors['last-name'] || personalErrors['first-name']) &&
                  activeStep === 1
                ) {
                  labelProps.error = true;
                } else if ((socialErrors.google || socialErrors.twitter || socialErrors.facebook || socialErrors.linkedIn) && activeStep === 2) {
                  labelProps.error = true;
                } else {
                  labelProps.error = false;
                }
